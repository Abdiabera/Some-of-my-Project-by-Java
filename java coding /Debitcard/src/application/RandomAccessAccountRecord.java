...
public class RandomAccessAccountRecord extends   AccountRecord {
   ...
   public RandomAccessAccountRecord( int account, 
      String firstName, String lastName, double balance, int socialSecurity,String email  )
   {
      super( account, firstName, lastName, balance, socialSecurity, email );
   }
   ...
   public void write( RandomAccessFile file ) throws IOException
   {
      ...
      writeName( file, getemail(),32 );
      file.writeInt( getsocialSecurity()); 
